...
public class DualPreviewControl : UserControl
{
    ...
    public DualPreviewControl()
    {
        ...
        obGrid.RowDefinitions.Add(new RowDefinition { Height = new GridLength(1, GridUnitType.Star) });
        OriginalHint = new TextBlock { FontWeight = FontWeights.SemiBold, Foreground = new SolidColorBrush(Color.FromArgb(255, 51, 51, 51)), Margin = new Thickness(2,0,2,4), Text = "原始预览 (Original)" };
        ...
        centerStack.Children.Add(new TextBlock { FontSize = 18, Foreground = new SolidColorBrush(Color.FromArgb(255, 90, 99, 112)), Text = "↓ ↓" });
        ...
        cbGrid.RowDefinitions.Add(new RowDefinition { Height = new GridLength(1, GridUnitType.Star) });
        ConvertedHint = new TextBlock { FontWeight = FontWeights.SemiBold, Foreground = new SolidColorBrush(Color.FromArgb(255, 51, 51, 51)), Margin = new Thickness(2,0,2,4), Text = "结果预览 (Converted)" };
