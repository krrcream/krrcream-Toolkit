...
namespace krrTools.tools.Shared
{
    ...
    {
        private static string BaseFolder => Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), OptionsConstants.BaseAppFolderName);
        ...
        {
            string folder = GetToolFolder(Path.Combine(toolName, OptionsConstants.PresetsFolderName));
            Directory.CreateDirectory(folder);
