...
namespace krrTools.tools.KRRLNTransformer
{
    public class KRRLN
    {
        ...
        public string ProcessFiles(string filepath, KRRLNTransformerOptions parameters)
        {
        ...
        private List<int> SelectPositionsByWeight(int[,] mtx, int row, List<int> validPositions, int removeCount, Random random)
        {
