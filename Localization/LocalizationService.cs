...
#region 核心语言管理
        ...
        private static readonly ConcurrentDictionary<string, DynamicLocalizedString>
            _localizedStringCache = new ConcurrentDictionary<string, DynamicLocalizedString>();

        private static readonly ConcurrentDictionary<Type, ConcurrentDictionary<string, string[]>>
            _enumCache = new ConcurrentDictionary<Type, ConcurrentDictionary<string, string[]>>();
        ...
        public static void ToggleLanguage()
        {
            ...
            Logger.WriteLine(LogLevel.Information, $"[LocalizationService] ToggleLanguage: ForceChinese set to {IsChinese}");
